          ...
          <nav id="menuzord-right" class="menuzord default no-bg">
            ...
            <ul class="menuzord-menu">
              ...
              <li><a href="#">K-Star Training</a>
                <ul class="dropdown">
                  <li><a href="features-preloader.html">K-Idol Training</a></li>
                  <li><a href="#">K-Model Training</a>
                  </li>
                  <li><a href="#">K-Acting Training</a>
                  </li>
                  <li><a href="#">K-Rap Training</a>
                  </li>
                </ul>
              </li>
              <li><a href="#">Talent Counseling</a>
              </li>
              <li><a href="#home">Online Course</a>
                <ul class="dropdown">
                  <li><a href="page-course-gird.html">Korean Online Course</a></li>
                  <li><a href="page-course-list.html">Vocal Online Course</a></li>
                </ul>
              </li>
              <li><a href="#">Online Audition</a>
              </li>
              <li><a href="#">K-Style</a>
              </li>
  ...
  <footer id="footer" class="footer" data-bg-color="#212331">
      ...
      <div class="row">
        <div class="col-sm-6 col-md-3">
          <div class="widget dark">
            <img class="mt-5 mb-20" alt="" src="{{asset('assets/images/logo-white-footer.png')}}">
    ...
    <div class="footer-bottom" data-bg-color="#2b2d3b">
      <div class="container pt-20 pb-20">
        <div class="row">
          <div class="col-md-6">
            <p class="font-12 text-black-777 m-0 sm-text-center">© 2019. Inspiredsteps. All Rights Reserved.</p>
          </div>
