                ...
                <div class="megamenu megamenu-bg-img">
                  <div class="megamenu-row">
                    ...
                    <div class="col3">
                      ...
                      <article class="post clearfix">
                        <div class="entry-header">
                          <div class="post-thumb"> <img class="img-responsive" src="{{asset('assets/images/blog/1.jpg')}}" alt=""> </div>
                        </div>
                    ...
                    <div class="col3">
                      ...
                      <img src="{{asset('assets/images/megamenu/megamenu-sale-off.jpg')}}" alt="">
                    </div>
                    <div class="col3">
